        ...
        <div class="card container mt-4 p-4">
            <form action="validate_signup.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="email">メールアドレス <span class="badge bg-warning text-white">必須</span></label></label>
                ...
                <?php endif; ?>
                <div class="form-group">
                    <label for="user_name">よんでID <span class="badge bg-warning text-white">必須</span></label></label>
                ...
                <?php endif; ?>
                <div class="form-group">
                    <label for="password">パスワード <span class="badge bg-warning text-white">必須</span></label></label>
                ...
                <div class="form-group">
                    <label for="image">プロフィール画像 <span class="badge bg-light">任意</span></label></label><br>
