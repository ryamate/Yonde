...
<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteId<?= $stored_picture_book['id'] ?>" title="絵本を本棚から削除する"><i class="far fa-trash-alt"></i></button>
<!-- Modal -->
